...
namespace ERP.UI.ViewModel
{
    ...
    public enum NachrichtTyp
    {
        ...
        JaNein,
        /// <summary>
        /// Gibt einen MessageBox mit Schaltflächen Info "Fehler"an
        /// </summary>
         Fehler,
         Info,
         Warnung
    ...
    internal static class NachrichtBox
    {
        ...
        public static void ZeigeFehler(string text)
        {
            NachrichtBox.Anzeigen(text, NachrichtTyp.Fehler);
        }


        public static void ZeigeInfo(string text)
        {
            NachrichtBox.Anzeigen(text, NachrichtTyp.Info);
        }

        public static void ZeigeWarnung(string text)
        {
            NachrichtBox.Anzeigen(text, NachrichtTyp.Warnung);
        }
        /// <summary>
