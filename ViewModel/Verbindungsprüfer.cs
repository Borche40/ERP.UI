...
namespace ERP.UI.ViewModel
{
    ...
    public static class Verbindungsprüfer
    {
        ...
        public static async Task<bool> PrüfeServerVerbindung(int timeoutMs = 5000)
        {
            ...
            return !ERP.UI.Properties.Settings.Default.Offline;
        }
        ...
        {
            bool verbindungOk = await Verbindungsprüfer.PrüfeServerVerbindung();

            //ERP.UI.Properties.Settings.Default.Offline = !verbindungOk;
            ERP.UI.Properties.Settings.Default.Save();
        }
    }
}
